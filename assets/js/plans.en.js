(function () {
  ...
  // ---------- DATA (EN) ----------
  // Each tab has cards. Each card supports monthly and upfront (one-time or prepaid).
  // "cta" is optional; if absent, generic CTA is shown in the page section.
  const DATA = {
    usaWeb: {
      currency: "USD",
      note: "Hosting and domain not included. Stripe fees billed by Stripe.",
      plans: [
        {
          name: "Starter Site",
          tagline: "Fast 1–3 pages, lead capture",
          monthly: 350,
          upfront: 1500,
          features: [
            "Custom design (no templates)",
            "Vue 3 static site + contact form",
            "Basic SEO & analytics",
            "Delivery 1–2 weeks"
          ]
        },
        {
          name: "Business",
          tagline: "Multi-page + blog",
          monthly: 690,
          upfront: 2800,
          highlight: true,
          features: [
            "Vue 3 + headless CMS (blog)",
            "A11y, performance & on-page SEO",
            "GA4 + events via GTM",
            "Delivery 3–4 weeks"
          ]
        },
        {
          name: "E-commerce",
          tagline: "Stripe Checkout & orders",
          monthly: 990,
          upfront: 4200,
          features: [
            "Products, variants & stock",
            "Stripe Checkout + coupons + tax",
            "Orders dashboard & email hooks",
            "Delivery 4–6 weeks"
          ]
        }
      ]
      ...
      plans: [
        {
          ...
          upfront: 950,
          features: [
            "One platform (Meta or Google)",
            "2–3 campaigns, 4–6 creatives",
            "Weekly optimization",
            "Simple report"
          ]
        },
    ...
    colWeb: {
      currency: "COP",
      note: "No incluye hosting ni dominio. Tarifas de Stripe las factura Stripe.",
      plans: [
        {
          name: "Landing",
      ...
      plans: [
        ...
        },
        {
          ...
          features: [
            "Banco de plantillas",
            "Guiones y edición",
            "Piezas para IG/TikTok/YT Shorts",
            "Reporte avanzado"
          ]
        }
      ]
  ...
  function cardTemplate(plan, currency, billing) {
    ...
    const priceNote = billing === "upfront" ? "one-time" : "per month";
    return `
      <div class="col-md-4">
        <div class="pricing-item h-100 ${plan.highlight ? "featured" : ""}">
          ...
          <div class="mt-auto d-grid">
            <a class="btn ${plan.highlight ? "btn-primary" : "btn-outline-primary"}" href="mailto:info@marcapro.agency?subject=${encodeURIComponent("Interest in: "+plan.name)}">Get this plan</a>
          </div>
        </div>
      </div>
    `;
  ...
  // Deep-link via hash: #tab=bla&billing=upfront
  function readHash() {
