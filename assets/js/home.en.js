  ...
  const projects = [
    {
      id: 'cushion',
      name: 'Cushion',
      subtitle: 'Emerald & Jewelry Store',
      year: 2026,
      ...
      githubUrl: '',
      challenge: 'Create a high-end experience for emerald sales, allowing customization and direct contact without traditional checkout friction.',
      solutions: [
        'Frontend built with Vite and Vue 3 focused on premium jewelry display.',
        'Custom shopping flow: cart redirects to WhatsApp to coordinate customization and shipping.',
        'Robust Spring Boot backend architecture deployed on Hetzner and Cloudflare.',
      ],
      results: 'A luxury boutique feel that humanizes jewelry sales, making personalization and trust-building effortless.',
    },
    {
      id: 'pet-station',
      name: 'Pet Station',
      ...
      githubUrl: '',
      challenge: 'Evolving from a service-based site to an e-commerce platform with pet management and smart product filtering.',
      solutions: [
        'User dashboard with personalized profiles to manage each pet’s data.',
        'Dynamic filtering system: the store recommends products based on the specific pet selected in the profile.',
        'Checkout via WhatsApp for more flexible logistics and personalized service.',
      ],
      results: 'Increased user retention through profile personalization and faster order processing.',
    },
    {
      id: 'lcs',
    ...
    },
    {
      ...
      thumbnail: '/assets/images/tasca-web.png',
    ...
    },
    {
      ...
      year: 2025,
      categories: ['web', 'marketing', 'branding'],
      thumbnail: '/assets/images/pintxo-web.png',
